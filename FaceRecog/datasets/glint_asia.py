...
class GlintAsiaDataset(Dataset):
    ...
    def __init__(self,
                 ...
                 format_size=112,
                 shuffle=False):
        super(GlintAsiaDataset, self).__init__()
    ...
    def _load_data_info(self):
        ...
        pickle_fpath = os.path.join(self.data_dir, 'preload_glint_aisa.pkl')
        if os.path.exists(pickle_fpath):
            print('pickle file for loading glint_asia data already exists, load it.')
            ...
            print('pickle file for loading glint_asia data not exist, start reading original data...')
            ...
            with open(pickle_fpath, 'wb') as f:
                ...
                print('pickle file for loading glint_asia data has been generated.')
    ...
    def _format(self, img_cv2, format_size):
    ...
    def __getitem__(self, idx):
        ...
        person_id = self.cls_idx_list[idx]
        self.n_count += 1
