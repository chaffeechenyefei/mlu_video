...
def main():
    # include_datasets = ['/ufs_ocr/faces_emore']
    include_datasets = ['/data/data/faces_glintasia']
    rec_list = []
    ...
    # output = '/data/data/emore/released_data'
    output = '/data/data/glintasia/released_data'
    ...
    for ds_id in range(len(rec_list)):
        ...
        for identity in seq_identity:
            ...
            id_dir = os.path.join(output, "%d" % (identity))
            os.makedirs(id_dir)
            pp += 1
            if pp % 10 == 0:
