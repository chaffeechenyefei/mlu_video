...
class SEBlock(nn.Module):
    def __init__(self, channel, reduction=16):
        ...
        self.fc1 = nn.Conv2d(
            channel, channel // reduction, kernel_size=1, padding=0, bias=True)
        self.prelu = nn.PReLU(channel // reduction)
        self.fc2 = nn.Conv2d(
            channel // reduction, channel, kernel_size=1, padding=0, bias=True)
...
class ResNetFace(nn.Module):
    def __init__(self, block, layers, use_se=True, drop_ratio=0.4):
