...
#         self.ir_head_bn = nn.BatchNorm2d(num_features=in_channel)
...
#             nn.BatchNorm2d(num_features=out_channel)
#         )
#         self.ir_tail_act = nn.PReLU(num_parameters=out_channel)
#
#         self.use_se = use_se
#         if self.use_se:
...
class SEResNetIR(nn.Module):
    ...
    def _build_body(self):
        ...
        for unit_idx, n_block in enumerate(self.unit_blocks):
            ...
            stride = (2, 2) if unit_idx > 0 else (1, 1)
            modules.append(
